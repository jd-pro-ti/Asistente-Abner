...
def open_w_files():
    ...
    title_label = Label(window_files, text="Agregar un archivo", bg="#6DD5FA", fg="#434343", font=('Arial', 15, 'bold'))
    title_label.pack(pady=3)
    name_label  = Label(window_files, text="Nombre del archivo", bg="#6DD5FA", fg="#434343", font=('Arial', 11, 'bold'))
    name_label.pack(padx=2)

    namefile_entry = Entry(window_files)
    namefile_entry.pack(pady=1)

    path_label  = Label(window_files, text="Ruta del archivo", bg="#6DD5FA", fg="#434343", font=('Arial', 11, 'bold'))
    path_label.pack(padx=2)
    
    pathf_entry = Entry(window_files, width=35)
    pathf_entry.pack(padx=1)

    save_button = Button(window_files, text="Guardar", fg="white", bg="#16222A",
...
def open_w_apps ():
    ...
    title_label = Label(window_apps, text="Agregar una App", bg="#6DD5FA", fg="#434343", font=('Arial', 15, 'bold'))
    title_label.pack(pady=3)
    name_label  = Label(window_apps, text="Nombre de la App", bg="#6DD5FA", fg="#434343", font=('Arial', 11, 'bold'))
    name_label.pack(padx=2)

    nameapps_entry = Entry(window_apps)
    nameapps_entry.pack(pady=1)

    path_label  = Label(window_apps, text="Ruta de la App", bg="#6DD5FA", fg="#434343", font=('Arial', 11, 'bold'))
    path_label.pack(padx=2)
    
    patha_entry = Entry(window_apps, width=35)
    patha_entry.pack(padx=1)

    save_button = Button(window_apps, text="Guardar", fg="white", bg="#16222A",
...
def open_w_pages():
    ...
    title_label = Label(window_pages, text="Agregar una pagina web", bg="#6DD5FA", fg="#434343", font=('Arial', 15, 'bold'))
    title_label.pack(pady=3)
    name_label  = Label(window_pages, text="Nombre de la pagina", bg="#6DD5FA", fg="#434343", font=('Arial', 11, 'bold'))
    name_label.pack(padx=2)

    namepages_entry = Entry(window_pages)
    namepages_entry.pack(pady=1)

    path_label  = Label(window_pages, text="URL de la App", bg="#6DD5FA", fg="#434343", font=('Arial', 11, 'bold'))
    path_label.pack(padx=2)
    
    pathp_entry = Entry(window_pages, width=35)
    pathp_entry.pack(padx=1)

    save_button = Button(window_pages, text="Guardar", fg="white", bg="#16222A",
...
def add_pages():
    ...
    url_file = pathp_entry.get().strip()

    programs[name_pages] = url_file
